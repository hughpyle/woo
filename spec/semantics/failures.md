...
| Cycle in `task:move` | parent ∈ descendants(task) | `E_RECMOVE` | rejected before mutation | nothing | check first; rebuild path | [taskspace DESIGN.md "Domain Invariants — Move"](../../catalogs/taskspace/DESIGN.md#domain-invariants) |
